...
const AppContent: React.FC = () => {
  ...
  const handleRegisterSuccess = () => {
    // If auto-login was successful, user will be logged in automatically
    // If auto-login failed, redirect to login modal
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 py-3 px-6 rounded-lg font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
                >
                  Ro'yxatdan o'tish
                </button>
              </div>
      ...
      case 'chat':
        return (
          <Chat 
            ...
            onConversationChange={setIsInChatConversation}
          />
        );
      case 'profile':
        return <Profile />;
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors flex flex-col">
      ...
      {/* Desktop Layout - Only show when user is logged in */}
      {user && (
        <div className="hidden lg:flex flex-1">
          {/* Sidebar */}
          <div className="w-72 bg-white dark:bg-gray-800 shadow-sm border-r border-gray-200 dark:border-gray-700 min-h-screen fixed left-0 top-16 transition-all duration-300">
            <div className="p-5">
              {/* Navigation */}
      ...
      {/* Login Layout - Show when user is not logged in */}
      {!user && (
      ...
      <div className="lg:hidden flex-1 flex flex-col">
        ...
        {user && !(currentView === 'chat' && isInChatConversation) && (
          <BottomNavigation 
