...
import { Search, MapPin, Star, Eye, MessageCircle, SlidersHorizontal } from 'lucide-react';
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <select
                ...
                className="flex-1 px-3 lg:px-4 py-3 text-base border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-3 lg:px-4 py-3 text-base bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors whitespace-nowrap"
              >
